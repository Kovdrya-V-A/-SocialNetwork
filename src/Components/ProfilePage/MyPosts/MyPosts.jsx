...
const MyPosts = (props) => {
    ...
    let postsItems =
        props.postsData.map(p => p.isDeleted ? null : <Post key = {p.idPost} avaImg={props.avaImg} name = {props.name} text={p.text} dateTime = {p.dateTime} idPost={p.idPost} onDeletePost = {props.onDeletePost}/>)
